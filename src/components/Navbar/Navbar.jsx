  ...
  return (
    <div>
      <nav className="navbar navbar-expand-md px-0 py-0 pt-3 pt-md-5 justify-content-start align-items-baseline">
        <button
          className={`navbar-toggler ${styles.collapseButton} p-0`}
          data-toggle="collapse"
          data-target="#collapse-target"
        >
          <img
            className={`${styles.menu}`}
            src="assets/navbar_collapse_menu.svg"
          ></img>
        </button>
        ...
        <span
          className={`navbar-text d-none d-md-inline ${styles.brandStrong}`}
        >
          Static <span className={`${styles.brand}`}>Elements</span>{" "}
        </span>
        ...
        <div className="row no-gutters ml-auto align-items-center">
          ...
          <p className={`${styles.account} mr-2`}>Alex Durant</p>
      ...
      <nav
        className={`navbar navbar-expand-md sticky-top px-0 pt-3 pt-md-4 pb-4 `}
      >
